...
#include <unistd.h>
#include <signal.h>
#include "/Users/veitheller/Documents/Code/Github/carp/archive/sqlite3/sqlite3_helper.h"
...
typedef struct Result__Array__Array__SQLite3Type_String Result__Array__Array__SQLite3Type_String;
...
typedef struct Result__SQLite_String Result__SQLite_String;
...
typedef struct SQLite3Type SQLite3Type;
...
#define SQLite3Type_Null_tag 0
#define SQLite3Type_Integer_tag 1
#define SQLite3Type_Floating_tag 2
#define SQLite3Type_Text_tag 3
#define SQLite3Type_Blob_tag 4

// Depth 4
typedef Array Array__Array__SQLite3Type;
...
// Depth 4
typedef Array Array__SQLite3Type;

// Depth 4
typedef Array Array__SQLiteColumn;
...
#define Result__SQLite_String_Success_tag 0
#define Result__SQLite_String_Error_tag 1
...
// Depth 505
typedef SQLite3Type(*Fn__SQLite3Type_MUL__SQLite3Type)(SQLite3Type*);

// Depth 505
typedef SQLiteColumn(*Fn__SQLite3Type_MUL__SQLiteColumn)(SQLite3Type*);

// Depth 505
typedef String(*Fn__SQLite3Type_MUL__String)(SQLite3Type*);

// Depth 505
typedef SQLiteColumn(*Fn__SQLite3Type_SQLiteColumn)(SQLite3Type);

// Depth 505
typedef int(*Fn__SQLiteColumn_MUL__int)(SQLiteColumn*);

// Depth 505
typedef SQLite3Type(*Fn__SQLiteColumn_SQLite3Type)(SQLiteColumn);

// Depth 505
typedef String(*Fn__SQLiteColumn_String)(SQLiteColumn);

// Depth 505
typedef double(*Fn__SQLiteColumn_double)(SQLiteColumn);

// Depth 505
typedef int(*Fn__SQLiteColumn_int)(SQLiteColumn);

// Depth 505
typedef CChar*(*Fn__SQLiteRes_CChar_MUL_)(SQLiteRes);

// Depth 505
typedef bool(*Fn__SQLiteRes_MUL__bool)(SQLiteRes*);

// Depth 505
typedef int(*Fn__SQLiteRes_MUL__int)(SQLiteRes*);

// Depth 505
typedef SQLiteRow(*Fn__SQLiteRes_MUL__int_SQLiteRow)(SQLiteRes*, int);

// Depth 505
typedef int(*Fn__SQLiteRow_MUL__int)(SQLiteRow*);

// Depth 505
typedef SQLiteColumn(*Fn__SQLiteRow_MUL__int_SQLiteColumn)(SQLiteRow*, int);

// Depth 505
typedef CChar*(*Fn__SQLite_CChar_MUL_)(SQLite);

// Depth 505
typedef int(*Fn__SQLite_MUL__CChar_MUL__int)(SQLite*, CChar*);

// Depth 505
typedef void(*Fn__SQLite_void)(SQLite);

// Depth 505
typedef CChar*(*Fn__String_MUL__CChar_MUL_)(String*);

// Depth 505
typedef SQLite3Type(*Fn__String_SQLite3Type)(String);

// Depth 505
typedef SQLiteColumn(*Fn__String_SQLiteColumn)(String);

// Depth 505
typedef SQLite(*Fn___SQLite)();

// Depth 505
typedef SQLite3Type(*Fn___SQLite3Type)();

// Depth 505
typedef SQLiteColumn(*Fn___SQLiteColumn)();

// Depth 505
typedef SQLite3Type(*Fn__double_SQLite3Type)(double);

// Depth 505
typedef SQLiteColumn(*Fn__double_SQLiteColumn)(double);

// Depth 505
typedef CChar*(*Fn__int_CChar_MUL_)(int);

// Depth 505
typedef SQLite3Type(*Fn__int_SQLite3Type)(int);

// Depth 505
typedef SQLiteColumn(*Fn__int_SQLiteColumn)(int);

// Depth 507
typedef SQLite(*Fn__Result__SQLite_String_SQLite)(Result__SQLite_String);

// Depth 507
typedef Result__SQLite_String(*Fn__SQLite_Result__SQLite_String)(SQLite);

// Depth 507
typedef Result__SQLite_String(*Fn__String_MUL__Result__SQLite_String)(String*);

// Depth 507
typedef Result__SQLite_String(*Fn__String_Result__SQLite_String)(String);
...
// Depth 508
typedef String(*Fn__Array__SQLite3Type_MUL__String)(Array__SQLite3Type*);

// Depth 508
typedef int(*Fn__Array__SQLite3Type_MUL__int)(Array__SQLite3Type*);

// Depth 508
typedef SQLite3Type*(*Fn__Array__SQLite3Type_MUL__int_SQLite3Type_MUL_)(Array__SQLite3Type*, int);

// Depth 508
typedef void(*Fn__Array__SQLite3Type_MUL__int_SQLite3Type_void)(Array__SQLite3Type*, int, SQLite3Type);

// Depth 508
typedef void(*Fn__Array__SQLiteColumn_MUL__int_SQLiteColumn_void)(Array__SQLiteColumn*, int, SQLiteColumn);
...
// Depth 508
typedef Array__SQLiteColumn(*Fn__Fn__SQLite3Type_MUL__SQLiteColumn_MUL__Array__SQLite3Type_MUL__Array__SQLiteColumn)(Lambda*, Array__SQLite3Type*);

// Depth 508
typedef Array__PatternMatchResult(*Fn__Pattern_MUL__String_MUL__Array__PatternMatchResult)(Pattern*, String*);

// Depth 508
typedef Array__SQLite3Type(*Fn__SQLiteRow_Array__SQLite3Type)(SQLiteRow);

// Depth 508
typedef SQLiteRes(*Fn__SQLite_MUL__CChar_MUL__Array__SQLiteColumn_MUL__SQLiteRes)(SQLite*, CChar*, Array__SQLiteColumn*);

// Depth 508
typedef Array__SQLite3Type(*Fn__int_Array__SQLite3Type)(int);

// Depth 508
typedef Array__SQLiteColumn(*Fn__int_Array__SQLiteColumn)(int);

// Depth 510
struct Result__Array__Array__SQLite3Type_String {
    union {
    struct {
        Array__Array__SQLite3Type member0;
    } Success;
    struct {
        String member0;
    } Error;
...
#define Result__Array__Array__SQLite3Type_String_Success_tag 0
#define Result__Array__Array__SQLite3Type_String_Error_tag 1

// Depth 511
typedef String(*Fn__Array__Array__SQLite3Type_MUL__String)(Array__Array__SQLite3Type*);

// Depth 511
typedef void(*Fn__Array__Array__SQLite3Type_MUL__int_Array__SQLite3Type_void)(Array__Array__SQLite3Type*, int, Array__SQLite3Type);

// Depth 511
typedef Array__Array__SQLite3Type(*Fn__SQLiteRes_Array__Array__SQLite3Type)(SQLiteRes);

// Depth 511
typedef Array__Array__SQLite3Type(*Fn__int_Array__Array__SQLite3Type)(int);

// Depth 513
typedef Result__Array__Array__SQLite3Type_String(*Fn__Array__Array__SQLite3Type_Result__Array__Array__SQLite3Type_String)(Array__Array__SQLite3Type);

// Depth 513
typedef String(*Fn__Result__Array__Array__SQLite3Type_String_MUL__String)(Result__Array__Array__SQLite3Type_String*);

// Depth 513
typedef Result__Array__Array__SQLite3Type_String(*Fn__SQLite_MUL__String_MUL__Array__SQLite3Type_MUL__Result__Array__Array__SQLite3Type_String)(SQLite*, String*, Array__SQLite3Type*);

// Depth 513
typedef Result__Array__Array__SQLite3Type_String(*Fn__String_Result__Array__Array__SQLite3Type_String)(String);
...
// Depth 500
Array Array_allocate__Array__SQLite3Type (int n);
...
// Depth 500
Array Array_allocate__SQLite3Type (int n);

// Depth 500
Array Array_allocate__SQLiteColumn (int n);
...
// Depth 500
void Array_aset_MINUS_uninitialized_BANG___Array__SQLite3Type (Array *aRef, int n, Array__SQLite3Type newValue);
...
// Depth 500
void Array_aset_MINUS_uninitialized_BANG___SQLite3Type (Array *aRef, int n, SQLite3Type newValue);

// Depth 500
void Array_aset_MINUS_uninitialized_BANG___SQLiteColumn (Array *aRef, int n, SQLiteColumn newValue);
...
// Depth 500
Array__SQLiteColumn Array_copy_MINUS_map__SQLite3Type_SQLiteColumn(Lambda* f, Array__SQLite3Type* a);
...
// Depth 500
void Array_delete__Array__SQLite3Type (Array a);
...
// Depth 500
void Array_delete__SQLite3Type (Array a);

// Depth 500
void Array_delete__SQLiteColumn (Array a);
...
// Depth 500
int Array_length__SQLite3Type (Array *a);
...
// Depth 500
String Array_prn__Array__SQLite3Type(Array__Array__SQLite3Type* x);

// Depth 500
String Array_prn__SQLite3Type(Array__SQLite3Type* x);
...
// Depth 500
String Array_str__Array__SQLite3Type (Array* a);

// Depth 500
String Array_str__SQLite3Type (Array* a);
...
// Depth 500
SQLite3Type* Array_unsafe_MINUS_nth__SQLite3Type (Array *aRef, int n);
...
// Depth 500
SQLite3Type Bool_to_MINUS_sqlite3(bool b);
...
// Depth 500
SQLite3Type Double_to_MINUS_sqlite3(double d);
...
// Depth 500
SQLite3Type Float_to_MINUS_sqlite3(float f);
...
// Depth 500
void Function_delete__SQLite3Type_MUL__SQLiteColumn (Lambda f);
...
// Depth 500
SQLite3Type Int_to_MINUS_sqlite3(int i);
...
// Depth 500
SQLite3Type Long_to_MINUS_sqlite3(Long l);
...
// Depth 500
Result__Array__Array__SQLite3Type_String Result_Error__String_Array__Array__SQLite3Type(String member0);
...
// Depth 500
Result__SQLite_String Result_Error__String_SQLite(String member0);
...
// Depth 500
Result__Array__Array__SQLite3Type_String Result_Success__Array__Array__SQLite3Type_String(Array__Array__SQLite3Type member0);
...
// Depth 500
Result__SQLite_String Result_Success__SQLite_String(SQLite member0);
...
// Depth 500
void Result_delete__Array__Array__SQLite3Type_String(Result__Array__Array__SQLite3Type_String p);
...
// Depth 500
void Result_delete__SQLite_String(Result__SQLite_String p);
...
// Depth 500
String Result_str__Array__Array__SQLite3Type_String(Result__Array__Array__SQLite3Type_String *p);
...
// Depth 500
SQLite Result_unsafe_MINUS_from_MINUS_success__SQLite_String(Result__SQLite_String a);
...
// Depth 500
SQLiteColumn SQLite3__Lambda_query_24_env(SQLite3Type* x);

// Depth 500
Result__SQLite_String SQLite3_open(String* s);

// Depth 500
Result__Array__Array__SQLite3Type_String SQLite3_query(SQLite* db, String* s, Array__SQLite3Type* p);

// Depth 1000

// Depth 500
SQLite3Type SQLite3_SQLiteColumn_to_MINUS_carp(SQLiteColumn c);

// Depth 1000

// Depth 500
Array__Array__SQLite3Type SQLite3_SQLiteRes_to_MINUS_array(SQLiteRes r);

// Depth 1000

// Depth 500
Array__SQLite3Type SQLite3_SQLiteRow_to_MINUS_carp(SQLiteRow r);

// Depth 1000

// Depth 500
SQLite3Type SQLite3_Type_Blob(String member0);

// Depth 500
SQLite3Type SQLite3_Type_Floating(double member0);

// Depth 500
SQLite3Type SQLite3_Type_Integer(int member0);

// Depth 500
SQLite3Type SQLite3_Type_Null();

// Depth 500
SQLite3Type SQLite3_Type_Text(String member0);

// Depth 500
SQLite3Type SQLite3_Type_copy(SQLite3Type* pRef);

// Depth 500
void SQLite3_Type_delete(SQLite3Type p);

// Depth 500
int SQLite3_Type_get_MINUS_tag(SQLite3Type *p);

// Depth 500
String SQLite3_Type_prn(SQLite3Type* s);

// Depth 500
String SQLite3_Type_str(SQLite3Type *p);

// Depth 500
SQLiteColumn SQLite3_Type_to_MINUS_sqlite3_MINUS_internal(SQLite3Type x);
...
// Depth 500
SQLite3Type String_to_MINUS_sqlite3(String s);
...
Array Array_allocate__Array__SQLite3Type (int n) {
    ...
    a.len = n;
    a.capacity = n;
    a.data = CARP_MALLOC(n*sizeof(Array__SQLite3Type));
    return a;
}
...
Array Array_allocate__SQLite3Type (int n) {
    ...
    a.len = n;
    a.capacity = n;
    a.data = CARP_MALLOC(n*sizeof(SQLite3Type));
    return a;
}
...
Array Array_allocate__SQLiteColumn (int n) {
    ...
    a.len = n;
    a.capacity = n;
    a.data = CARP_MALLOC(n*sizeof(SQLiteColumn));
    return a;
}
...
void Array_aset_MINUS_uninitialized_BANG___Array__SQLite3Type (Array *aRef, int n, Array__SQLite3Type newValue) {
    ...
    assert(n >= 0);
    assert(n < a.len);
    ((Array__SQLite3Type*)a.data)[n] = newValue;
}
...
void Array_aset_MINUS_uninitialized_BANG___SQLiteColumn (Array *aRef, int n, SQLiteColumn newValue) {
    ...
    assert(n >= 0);
    assert(n < a.len);
    ((SQLiteColumn*)a.data)[n] = newValue;
}
...
Array__SQLiteColumn Array_copy_MINUS_map__SQLite3Type_SQLiteColumn(Lambda* f, Array__SQLite3Type* a) {
    Array__SQLiteColumn _52;
    /* let */ {
        int _10 = Array_length__SQLite3Type(a);
        Array__SQLiteColumn _11 = Array_allocate__SQLiteColumn(_10);
        Array__SQLiteColumn na = _11;
        /* let */ {
            int i = 0;
            int _23 = Array_length__SQLite3Type(a);
            bool _1000008 = Int__LT_(i, _23);
            bool _1000006 = _1000008;
            while (_1000006) {
                Array__SQLiteColumn* _29 = &na; // ref
                SQLite3Type* _37 = Array_unsafe_MINUS_nth__SQLite3Type(a, i);
                SQLiteColumn _38 = (*f).env ? ((SQLiteColumn(*)(LambdaEnv, SQLite3Type*))(*f).callback)((*f).env, _37) : ((SQLiteColumn(*)(SQLite3Type*))(*f).callback)(_37);
                Array_aset_MINUS_uninitialized_BANG___SQLiteColumn(_29, i, _38);
                int _1000013 = Int__PLUS_(i, 1);
                i = _1000013;  // Int = Int
                int _23 = Array_length__SQLite3Type(a);
                bool _1000008 = Int__LT_(i, _23);
...
void Array_delete__Array__SQLite3Type (Array a){
    for(int i = 0; i < a.len; i++) {
        Array_delete__SQLite3Type(((Array__SQLite3Type*)a.data)[i]);
    }
    CARP_FREE(a.data);
}
...
void Array_delete__SQLite3Type (Array a){
    for(int i = 0; i < a.len; i++) {
        SQLite3_Type_delete(((SQLite3Type*)a.data)[i]);
    }
    CARP_FREE(a.data);
}
...
void Array_delete__SQLiteColumn (Array a){
    for(int i = 0; i < a.len; i++) {
        /* Ignore non-managed type inside Array: 'SQLiteColumn' */
    }
    CARP_FREE(a.data);
}
...
int Array_length__SQLite3Type (Array *a) { return (*a).len; }
...
String Array_prn__Array__SQLite3Type(Array__Array__SQLite3Type* x) {
    String _6 = Array_str__Array__SQLite3Type(x);
    return _6;
}

String Array_prn__SQLite3Type(Array__SQLite3Type* x) {
    String _6 = Array_str__SQLite3Type(x);
    return _6;
}
...
String Array_str__Array__SQLite3Type (Array* a) {
  ...
  for(int i = 0; i < a->len; i++) {
    temp = Array_prn__SQLite3Type(&((Array__SQLite3Type*)a->data)[i]);
...
String Array_str__SQLite3Type (Array* a) {
  ...
  int size = 3; // opening and closing brackets and terminator
  for(int i = 0; i < a->len; i++) {
    temp = SQLite3_Type_prn(&((SQLite3Type*)a->data)[i]);
    size += snprintf(NULL, 0, "%s ", temp);
    if(temp) {
      CARP_FREE(temp);
      temp = NULL;
...
SQLite3Type Bool_to_MINUS_sqlite3(bool b) {
    ...
    SQLite3Type _14 = SQLite3_Type_Integer(_13);
    return _14;
}
...
SQLite3Type Double_to_MINUS_sqlite3(double d) {
    SQLite3Type _6 = SQLite3_Type_Floating(d);
    return _6;
}
...
SQLite3Type Float_to_MINUS_sqlite3(float f) {
    double _7 = Double_from_MINUS_float(f);
    SQLite3Type _8 = SQLite3_Type_Floating(_7);
    return _8;
}
...
SQLite3Type Int_to_MINUS_sqlite3(int i) {
    SQLite3Type _6 = SQLite3_Type_Integer(i);
    return _6;
}
...
SQLite3Type Long_to_MINUS_sqlite3(Long l) {
    Long _9 = l; // From the 'the' function.
    int _10 = Long_to_MINUS_int(_9);
    SQLite3Type _11 = SQLite3_Type_Integer(_10);
    return _11;
}
...
Result__Array__Array__SQLite3Type_String Result_Error__String_Array__Array__SQLite3Type(String member0) {
  Result__Array__Array__SQLite3Type_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__Array__Array__SQLite3Type_String_Error_tag;
    return instance;
}
...
Result__SQLite_String Result_Error__String_SQLite(String member0) {
  Result__SQLite_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__SQLite_String_Error_tag;
    return instance;
}
...
Result__Array__Array__SQLite3Type_String Result_Success__Array__Array__SQLite3Type_String(Array__Array__SQLite3Type member0) {
  Result__Array__Array__SQLite3Type_String instance;
    ...
    instance._tag = Result__Array__Array__SQLite3Type_String_Success_tag;
    return instance;
}
...
Result__SQLite_String Result_Success__SQLite_String(SQLite member0) {
  Result__SQLite_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__SQLite_String_Success_tag;
    return instance;
}
...
void Result_delete__Array__Array__SQLite3Type_String(Result__Array__Array__SQLite3Type_String p) {
  if(p._tag == Result__Array__Array__SQLite3Type_String_Success_tag) {
    Array_delete__Array__SQLite3Type(p.u.Success.member0);
  }
  else if(p._tag == Result__Array__Array__SQLite3Type_String_Error_tag) {
...
void Result_delete__SQLite_String(Result__SQLite_String p) {
  if(p._tag == Result__SQLite_String_Success_tag) {
    /* Ignore non-managed member 'u.Success.member0' : SQLite */
  }
  else if(p._tag == Result__SQLite_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
String Result_str__Array__Array__SQLite3Type_String(Result__Array__Array__SQLite3Type_String *p) {
  ...
  temp = Array_prn__Array__SQLite3Type(&p->u.Success.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  }
  if(p->_tag == Result__Array__Array__SQLite3Type_String_Error_tag) {
...
SQLite Result_unsafe_MINUS_from_MINUS_success__SQLite_String(Result__SQLite_String a) {
    SQLite _10;
    if(a._tag == Result__SQLite_String_Success_tag) {
        Result__SQLite_String _5_temp = a;
        SQLite x = _5_temp.u.Success.member0;
        // Case expr:
        _10 = x;
    }
    else UNHANDLED("Result.carp", 58);
...
SQLite3Type SQLite3_SQLiteColumn_to_MINUS_carp(SQLiteColumn c) {
    SQLite3Type _74;
    /* let */ {
        SQLiteColumn* _9 = &c; // ref
        int _10 = SQLiteColumn_tag(_9);
        int gensym_MINUS_generated1039 = _10;
        SQLite3Type _73;
        bool _16 = Int__EQ_(gensym_MINUS_generated1039, SQLITE_INTEGER);
        if (_16) {
            int _21 = SQLiteColumn_from_int(c);
            SQLite3Type _22 = SQLite3_Type_Integer(_21);
            SQLite3Type _23 = _22;
            _73 = _23;
        } else {
            SQLite3Type _71;
            bool _29 = Int__EQ_(gensym_MINUS_generated1039, SQLITE_FLOAT);
            if (_29) {
                double _34 = SQLiteColumn_from_float(c);
                SQLite3Type _35 = SQLite3_Type_Floating(_34);
                SQLite3Type _36 = _35;
                _71 = _36;
            } else {
                SQLite3Type _69;
                bool _42 = Int__EQ_(gensym_MINUS_generated1039, SQLITE_TEXT);
                if (_42) {
                    String _47 = SQLiteColumn_from_str(c);
                    SQLite3Type _48 = SQLite3_Type_Text(_47);
                    SQLite3Type _49 = _48;
                    _69 = _49;
                } else {
                    SQLite3Type _67;
                    bool _55 = Int__EQ_(gensym_MINUS_generated1039, SQLITE_BLOB);
                    if (_55) {
                        String _60 = SQLiteColumn_from_str(c);
                        SQLite3Type _61 = SQLite3_Type_Blob(_60);
                        SQLite3Type _62 = _61;
                        _67 = _62;
                    } else {
                        SQLite3Type _65 = SQLite3_Type_Null();
                        SQLite3Type _66 = _65;
                        _67 = _66;
                    }
                    SQLite3Type _68 = _67;
...
Array__Array__SQLite3Type SQLite3_SQLiteRes_to_MINUS_array(SQLiteRes r) {
    Array__Array__SQLite3Type _53;
    /* let */ {
        SQLiteRes* _9 = &r; // ref
        int _10 = SQLiteRes_length(_9);
        int l = _10;
        Array__Array__SQLite3Type _14 = Array_allocate__Array__SQLite3Type(l);
        Array__Array__SQLite3Type a = _14;
        /* let */ {
            int i = 0;
            bool _1000008 = Int__LT_(i, l);
            bool _1000006 = _1000008;
            while (_1000006) {
                Array__Array__SQLite3Type* _30 = &a; // ref
                SQLiteRes* _36 = &r; // ref
                SQLiteRow _38 = SQLiteRes_nth(_36, i);
                Array__SQLite3Type _39 = SQLite3_SQLiteRow_to_MINUS_carp(_38);
                Array_aset_MINUS_uninitialized_BANG___Array__SQLite3Type(_30, i, _39);
                int _1000013 = Int__PLUS_(i, 1);
                i = _1000013;  // Int = Int
                bool _1000008 = Int__LT_(i, l);
                _1000006 = _1000008;
        ...
        Array__Array__SQLite3Type _52 = a;
        _53 = _52;
    }
    return _53;
}
...
Array__SQLite3Type SQLite3_SQLiteRow_to_MINUS_carp(SQLiteRow r) {
    Array__SQLite3Type _53;
    /* let */ {
        SQLiteRow* _9 = &r; // ref
        int _10 = SQLiteRow_length(_9);
        int l = _10;
        Array__SQLite3Type _14 = Array_allocate__SQLite3Type(l);
        Array__SQLite3Type a = _14;
        /* let */ {
            int i = 0;
            bool _1000008 = Int__LT_(i, l);
            bool _1000006 = _1000008;
            while (_1000006) {
                Array__SQLite3Type* _30 = &a; // ref
                SQLiteRow* _36 = &r; // ref
                SQLiteColumn _38 = SQLiteRow_nth(_36, i);
                SQLite3Type _39 = SQLite3_SQLiteColumn_to_MINUS_carp(_38);
                Array_aset_MINUS_uninitialized_BANG___SQLite3Type(_30, i, _39);
                int _1000013 = Int__PLUS_(i, 1);
                i = _1000013;  // Int = Int
                bool _1000008 = Int__LT_(i, l);
                _1000006 = _1000008;
...
SQLite3Type SQLite3_Type_Blob(String member0) {
  SQLite3Type instance;
    instance.u.Blob.member0 = member0;
    instance._tag = SQLite3Type_Blob_tag;
    return instance;
}

SQLite3Type SQLite3_Type_Floating(double member0) {
  SQLite3Type instance;
    instance.u.Floating.member0 = member0;
    instance._tag = SQLite3Type_Floating_tag;
    return instance;
}

SQLite3Type SQLite3_Type_Integer(int member0) {
  SQLite3Type instance;
    instance.u.Integer.member0 = member0;
    instance._tag = SQLite3Type_Integer_tag;
    return instance;
}
...
SQLite3Type SQLite3_Type_Null() {
  SQLite3Type instance;
    ...
    instance._tag = SQLite3Type_Null_tag;
    return instance;
}

SQLite3Type SQLite3_Type_Text(String member0) {
  SQLite3Type instance;
    instance.u.Text.member0 = member0;
    instance._tag = SQLite3Type_Text_tag;
    return instance;
}

SQLite3Type SQLite3_Type_copy(SQLite3Type* pRef) {
    SQLite3Type copy = *pRef;
    if(pRef->_tag == SQLite3Type_Null_tag) {

    }

    else if(pRef->_tag == SQLite3Type_Integer_tag) {
    /* Ignore non-managed member 'u.Integer.member0' : Int */
    }

    else if(pRef->_tag == SQLite3Type_Floating_tag) {
    /* Ignore non-managed member 'u.Floating.member0' : Double */
    }

    else if(pRef->_tag == SQLite3Type_Text_tag) {
    copy.u.Text.member0 = String_copy(&(pRef->u.Text.member0));
    }

    else if(pRef->_tag == SQLite3Type_Blob_tag) {
    copy.u.Blob.member0 = String_copy(&(pRef->u.Blob.member0));
    }
...
void SQLite3_Type_delete(SQLite3Type p) {
  if(p._tag == SQLite3Type_Null_tag) {

  }
  else if(p._tag == SQLite3Type_Integer_tag) {
    /* Ignore non-managed member 'u.Integer.member0' : Int */
  }
  else if(p._tag == SQLite3Type_Floating_tag) {
    /* Ignore non-managed member 'u.Floating.member0' : Double */
  }
  else if(p._tag == SQLite3Type_Text_tag) {
    String_delete(p.u.Text.member0);
  }
  else if(p._tag == SQLite3Type_Blob_tag) {
    String_delete(p.u.Blob.member0);
  }

}

int SQLite3_Type_get_MINUS_tag(SQLite3Type *p) { return p->_tag; }
String SQLite3_Type_prn(SQLite3Type* s) {
    String _6 = SQLite3_Type_str(s);
    return _6;
}
...
String SQLite3_Type_str(SQLite3Type *p) {
  ...
  int size = 1;
  if(p->_tag == SQLite3Type_Null_tag) {
    size += snprintf(NULL, 0, "(%s ", "Null");

  }
  if(p->_tag == SQLite3Type_Integer_tag) {
    size += snprintf(NULL, 0, "(%s ", "Integer");
  temp = Int_prn(p->u.Integer.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  }
  if(p->_tag == SQLite3Type_Floating_tag) {
    size += snprintf(NULL, 0, "(%s ", "Floating");
  temp = Double_prn(p->u.Floating.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  }
  if(p->_tag == SQLite3Type_Text_tag) {
    size += snprintf(NULL, 0, "(%s ", "Text");
  temp = String_prn(&p->u.Text.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  }
  if(p->_tag == SQLite3Type_Blob_tag) {
    size += snprintf(NULL, 0, "(%s ", "Blob");
  temp = String_prn(&p->u.Blob.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  if(p->_tag == SQLite3Type_Null_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Null");

    bufferPtr--;
    snprintf(bufferPtr, size - (bufferPtr - buffer), ")");
  }
  if(p->_tag == SQLite3Type_Integer_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Integer");
  temp = Int_prn(p->u.Integer.member0);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  if(p->_tag == SQLite3Type_Floating_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Floating");
  temp = Double_prn(p->u.Floating.member0);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  if(p->_tag == SQLite3Type_Text_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Text");
  temp = String_prn(&p->u.Text.member0);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  if(p->_tag == SQLite3Type_Blob_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Blob");
  temp = String_prn(&p->u.Blob.member0);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
...
SQLiteColumn SQLite3_Type_to_MINUS_sqlite3_MINUS_internal(SQLite3Type x) {
    SQLiteColumn _34;
    if(x._tag == SQLite3Type_Null_tag) {
        SQLite3Type _5_temp = x;
        // Case expr:
        SQLiteColumn _9 = SQLiteColumn_nil();
        _34 = _9;
    }
    else if(x._tag == SQLite3Type_Integer_tag) {
        SQLite3Type _5_temp = x;
        int i = _5_temp.u.Integer.member0;
        // Case expr:
        SQLiteColumn _15 = SQLiteColumn_int(i);
        _34 = _15;
    }
    else if(x._tag == SQLite3Type_Floating_tag) {
        SQLite3Type _5_temp = x;
        double f = _5_temp.u.Floating.member0;
        // Case expr:
        SQLiteColumn _21 = SQLiteColumn_float(f);
        _34 = _21;
    }
    else if(x._tag == SQLite3Type_Text_tag) {
        SQLite3Type _5_temp = x;
        String s = _5_temp.u.Text.member0;
        // Case expr:
        SQLiteColumn _27 = SQLiteColumn_text(s);
        _34 = _27;
    }
    else if(x._tag == SQLite3Type_Blob_tag) {
        SQLite3Type _5_temp = x;
        String s = _5_temp.u.Blob.member0;
        // Case expr:
        SQLiteColumn _33 = SQLiteColumn_blob(s);
        _34 = _33;
    }
    else UNHANDLED("sqlite3.carp", 96);
    return _34;
}

SQLiteColumn SQLite3__Lambda_query_24_env(SQLite3Type* x) {
    SQLite3Type _22 = SQLite3_Type_copy(x);
    SQLiteColumn _23 = SQLite3_Type_to_MINUS_sqlite3_MINUS_internal(_22);
    return _23;
}

Result__SQLite_String SQLite3_open(String* s) {
    Result__SQLite_String _38;
    /* let */ {
        SQLite _7 = SQLite3_init();
        SQLite db = _7;
        SQLite* _12 = &db; // ref
        CChar* _15 = String_cstr(s);
        int _16 = SQLite3_open_c(_12, _15);
        int res = _16;
        Result__SQLite_String _37;
        bool _22 = Int__EQ_(res, SQLITE_OK);
        if (_22) {
            Result__SQLite_String _26 = Result_Success__SQLite_String(db);
            Result__SQLite_String _27 = _26;
            _37 = _27;
        } else {
            CChar* _33 = SQLite3_error(db);
            String _34 = String_from_MINUS_cstr(_33);
            Result__SQLite_String _35 = Result_Error__String_SQLite(_34);
            Result__SQLite_String _36 = _35;
            _37 = _36;
        }
        _38 = _37;
    }
...
Result__Array__Array__SQLite3Type_String SQLite3_query(SQLite* db, String* s, Array__SQLite3Type* p) {
    Result__Array__Array__SQLite3Type_String _54;
    /* let */ {
        CChar* _12 = String_cstr(s);
        // This lambda captures 0 variables: 
        Lambda _24 = {
          .callback = (void*)SQLite3__Lambda_query_24_env,
          .env = NULL,
          .delete = (void*)NULL,
          .copy = (void*)NULL
        };
        Lambda* _25 = &_24; // ref
        Array__SQLiteColumn _27 = Array_copy_MINUS_map__SQLite3Type_SQLiteColumn(_25, p);
        Array__SQLiteColumn* _28 = &_27; // ref
        SQLiteRes _29 = SQLite3_exec_c(db, _12, _28);
        SQLiteRes r = _29;
        Result__Array__Array__SQLite3Type_String _53;
        SQLiteRes* _35 = &r; // ref
        bool _36 = SQLiteRes_is_ok(_35);
        if (_36) {
            Array__Array__SQLite3Type _41 = SQLite3_SQLiteRes_to_MINUS_array(r);
            Result__Array__Array__SQLite3Type_String _42 = Result_Success__Array__Array__SQLite3Type_String(_41);
            Result__Array__Array__SQLite3Type_String _43 = _42;
            _53 = _43;
        } else {
            CChar* _49 = SQLiteRes_error(r);
            String _50 = String_from_MINUS_cstr(_49);
            Result__Array__Array__SQLite3Type_String _51 = Result_Error__String_Array__Array__SQLite3Type(_50);
            Result__Array__Array__SQLite3Type_String _52 = _51;
            _53 = _52;
        }
        _54 = _53;
        Array_delete__SQLiteColumn(_27);
        Function_delete__SQLite3Type_MUL__SQLiteColumn(_24);
    }
    return _54;
}
...
SQLite3Type String_to_MINUS_sqlite3(String s) {
    SQLite3Type _6 = SQLite3_Type_Text(s);
    return _6;
}
...
int main(int argc, char** argv) {
    ...
    /* let */ {
        static String _7 = "test.db";
        String *_7_ref = &_7;
        Result__SQLite_String _8 = SQLite3_open(_7_ref);
        SQLite _9 = Result_unsafe_MINUS_from_MINUS_success__SQLite_String(_8);
        SQLite db = _9;
        /* let */ {
            SQLite* _17 = &db; // ref
            static String _18 = "CREATE TABLE people (id INTEGER PRIMARY KEY AUTOINCREMENT, firstname TEXT, lastname TEXT, age INT);";
            String *_18_ref = &_18;
            Array _20 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(SQLite3Type) * 0) };
            Array__SQLite3Type* _21 = &_20; // ref
            Result__Array__Array__SQLite3Type_String _22 = SQLite3_query(_17, _18_ref, _21);
            Result__Array__Array__SQLite3Type_String _ = _22;
            /* () */
            Array_delete__SQLite3Type(_20);
            Result_delete__Array__Array__SQLite3Type_String(_);
        }
        /* let */ {
            SQLite* _31 = &db; // ref
            static String _32 = "INSERT INTO people VALUES(?1, ?2, ?3, ?4);";
            String *_32_ref = &_32;
            Array _50 = { .len = 4, .capacity = 4, .data = CARP_MALLOC(sizeof(SQLite3Type) * 4) };
            SQLite3Type _36 = Int_to_MINUS_sqlite3(1);
            ((SQLite3Type*)_50.data)[0] = _36;
            static String _39 = "Veit";
            String *_39_ref = &_39;
            String _40 = String_copy(_39_ref);
            SQLite3Type _41 = String_to_MINUS_sqlite3(_40);
            ((SQLite3Type*)_50.data)[1] = _41;
            static String _44 = "Heller";
            String *_44_ref = &_44;
            String _45 = String_copy(_44_ref);
            SQLite3Type _46 = String_to_MINUS_sqlite3(_45);
            ((SQLite3Type*)_50.data)[2] = _46;
            SQLite3Type _49 = Int_to_MINUS_sqlite3(26);
            ((SQLite3Type*)_50.data)[3] = _49;
            Array__SQLite3Type* _51 = &_50; // ref
            Result__Array__Array__SQLite3Type_String _52 = SQLite3_query(_31, _32_ref, _51);
            Result__Array__Array__SQLite3Type_String _ = _52;
            /* () */
            Array_delete__SQLite3Type(_50);
            Result_delete__Array__Array__SQLite3Type_String(_);
        }
        /* let */ {
            SQLite* _61 = &db; // ref
            static String _62 = "INSERT INTO people(firstname, lastname, age) VALUES(?3, ?2, ?1);";
            String *_62_ref = &_62;
            Array _76 = { .len = 3, .capacity = 3, .data = CARP_MALLOC(sizeof(SQLite3Type) * 3) };
            SQLite3Type _65 = SQLite3_Type_Null();
            ((SQLite3Type*)_76.data)[0] = _65;
            static String _68 = "Svedäng";
            String *_68_ref = &_68;
            String _69 = String_copy(_68_ref);
            SQLite3Type _70 = String_to_MINUS_sqlite3(_69);
            ((SQLite3Type*)_76.data)[1] = _70;
            static String _73 = "Erik";
            String *_73_ref = &_73;
            String _74 = String_copy(_73_ref);
            SQLite3Type _75 = String_to_MINUS_sqlite3(_74);
            ((SQLite3Type*)_76.data)[2] = _75;
            Array__SQLite3Type* _77 = &_76; // ref
            Result__Array__Array__SQLite3Type_String _78 = SQLite3_query(_61, _62_ref, _77);
            Result__Array__Array__SQLite3Type_String _ = _78;
            /* () */
            Array_delete__SQLite3Type(_76);
            Result_delete__Array__Array__SQLite3Type_String(_);
        }
        SQLite* _89 = &db; // ref
        static String _90 = "SELECT * FROM people;";
        String *_90_ref = &_90;
        Array _92 = { .len = 0, .capacity = 0, .data = CARP_MALLOC(sizeof(SQLite3Type) * 0) };
        Array__SQLite3Type* _93 = &_92; // ref
        Result__Array__Array__SQLite3Type_String _94 = SQLite3_query(_89, _90_ref, _93);
        Result__Array__Array__SQLite3Type_String* _95 = &_94; // ref
        String _1000009 = Result_str__Array__Array__SQLite3Type_String(_95);
        String* _1000008 = &_1000009; // ref
        IO_println(_1000008);
        SQLite3_close_c(db);
        Array_delete__SQLite3Type(_92);
        Result_delete__Array__Array__SQLite3Type_String(_94);
